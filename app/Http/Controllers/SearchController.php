...
class SearchController extends Controller
{
    ...
    public function search(Request $request)
    {
        ...
        $search_translation = $this->clearTranslationParameter(
            $request->input("search-translation", "rbo"),
        );
        $search_book = $request->input("search-book")
            ? $this->clearIntParameter($request->input("search-book"))
            : "";
        ...
        $books_list = DB::table($search_translation)->pluck(
            "book_name",
            "book_num",
        );
        ...
        $data = [
            ...
            "seo_title" =>
                __("Поиск по Библии.") . " | " . config("app.fullname"),
            "seo_description" =>
                __("Поиск по Библии") . " | " . config("app.desc"),
